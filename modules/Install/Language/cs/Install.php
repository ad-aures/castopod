...
return [
    ...
    'form' => [
        ...
        'admin_gateway' => 'Administrátorská brána',
        'admin_gateway_hint' =>
        ...
        'db_hostname' => 'Hostname databáze',
        'db_name' => 'Název databáze',
        'db_username' => 'Uživatelské k databázi',
        'db_password' => 'Heslo k databázi',
        'db_prefix' => 'Předpona databáze',
        'db_prefix_hint' =>
            "Předpona Castopod tabulky, ponechejte beze změn pokud nevíte co to znamená.",
        ...
        'create_superadmin' => 'Vytvořte si svůj Super Admin účet',
        'email' => 'E-mail',

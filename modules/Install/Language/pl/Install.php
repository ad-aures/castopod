...
return [
    ...
    'form' => [
        ...
        'admin_gateway_hint' =>
            'Dostęp do obszaru administracyjnego (np. https://example.com/cp-admin). Domyślnie jest ustawiony jako cp-admin, ale ze względów bezpieczeństwa zalecamy zmianę tej nazwy.',
    ...
    'messages' => [
        ...
        'databaseConnectError' =>
            'Castopod nie mógł się połączyć z Twoją bazą danych. Edytuj konfigurację bazy danych i spróbuj ponownie.',
        'writeError' =>

...
return [
    'podcast_subscriptions' => 'Assinaturas de Podcast',
    'add' => 'Nova assinatura',
    'view' => 'Visualizar assinatura',
    'edit' => 'Editar assinatura',
    'regenerate_token' => 'Regerar token',
    ...
    'form' => [
        'email' => 'E-mail',
        'expiration_date' => 'Data da expiração',
        'expiration_date_hint' => 'A data e hora em que a assinatura expirará. Deixe em branco para uma assinatura ilimitada.',
        'submit_create' => 'Criar assinatura',
        'submit_edit' => 'Editar assinatura',
    ],
    'form_link_add' => [
        'link' => 'Link da página de assinatura',
        'link_hint' => 'Isto irá adicionar uma chamada para a ação no site que convida ouvintes a se inscreverem no podcast.',
        'submit' => 'Salvar o link',
    ],
    'suspend_form' => [
